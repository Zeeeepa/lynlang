...
pub fn compile_literal_pattern<'ctx>(
    ...
    } = lit_expr
    {
        ...
        compiler
            .builder
            .build_and(ge_start, le_end, "range_match")
...
pub fn compile_range_pattern<'ctx>(
    ...
    let le_end = if *inclusive {
        compiler
            .builder
            .build_int_compare(IntPredicate::SLE, scrutinee_int, end_int, "range_le")?
    } else {
        compiler
            .builder
            .build_int_compare(IntPredicate::SLT, scrutinee_int, end_int, "range_lt")?
    };
...
pub fn compile_identifier_pattern<'ctx>(
