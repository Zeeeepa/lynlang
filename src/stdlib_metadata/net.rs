...
use crate::ast::{AstType, Declaration, Expression, ExternalFunction, Function, Statement};
...
fn create_tcp_functions() -> Vec<Declaration> {
    vec![
        ...
        Declaration::Function(Function {
            ...
            args: vec![("port".to_string(), AstType::U16)],
                ...
                expr: Expression::FunctionCall {
                    ...
                    args: vec![
                        Expression::StructField {
                            struct_: Box::new(Expression::Dereference(Box::new(
                                Expression::Identifier("socket".to_string()),
                            ))),
                            field: "fd".to_string(),
                        },
