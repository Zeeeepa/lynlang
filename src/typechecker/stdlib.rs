...
fn register_core_module(checker: &mut TypeChecker, alias: &str) {
    let core_funcs = vec![
        ...
        (
            "panic",
            vec![crate::ast::resolve_string_struct_type()],
            AstType::Void,
        ),
    ];
...
fn register_compiler_module(checker: &mut TypeChecker, alias: &str) {
    ...
    let compiler_funcs = vec![
        ...
        (
            "raw_deallocate",
            vec![raw_ptr_u8.clone(), AstType::Usize],
            AstType::Void,
        ),
        (
            "raw_reallocate",
            vec![raw_ptr_u8.clone(), AstType::Usize, AstType::Usize],
            raw_ptr_u8.clone(),
        ),
        (
            "raw_ptr_offset",
            vec![raw_ptr_u8.clone(), AstType::I64],
            raw_ptr_u8.clone(),
        ),
        ("raw_ptr_cast", vec![raw_ptr_u8.clone()], raw_ptr_u8.clone()),
        (
            "call_external",
            vec![raw_ptr_u8.clone(), raw_ptr_u8.clone()],
            raw_ptr_u8.clone(),
        ),
        (
            "load_library",
            vec![AstType::StaticString],
            raw_ptr_u8.clone(),
        ),
        (
            "get_symbol",
            vec![raw_ptr_u8.clone(), AstType::StaticString],
            raw_ptr_u8.clone(),
        ),
        ...
        (
            "gep_struct",
            vec![raw_ptr_u8.clone(), AstType::I32],
            raw_ptr_u8.clone(),
        ),
        // Enum intrinsics
    ...
    let ptr_funcs = vec![
        ...
        (
            "raw_deallocate",
            vec![ptr_u8.clone(), AstType::Usize],
            AstType::Void,
        ),
    ];
