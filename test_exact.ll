...
@str = private unnamed_addr constant [13 x i8] c"(0,0) -> %d\0A\00", align 1
@str.1 = private unnamed_addr constant [13 x i8] c"(0,1) -> %d\0A\00", align 1
@str.2 = private unnamed_addr constant [13 x i8] c"(1,0) -> %d\0A\00", align 1
@str.3 = private unnamed_addr constant [13 x i8] c"(1,1) -> %d\0A\00", align 1
...
match_merge:                                      ; preds = %pattern_unmatched, %match_merge6
  %match_result22 = phi i32 [ %match_result21, %match_merge6 ], [ 0, %pattern_unmatched ]
  ret i32 %match_result22
...
match_merge6:                                     ; preds = %pattern_unmatched11, %match_merge14, %match_1, %match_08
  %match_result21 = phi i32 [ 0, %match_08 ], [ 1, %match_1 ], [ %match_result, %match_merge14 ], [ 0, %pattern_unmatched11 ]
  br label %match_merge
...
test_117:                                         ; preds = %match_2
  ...
  br i1 %int_eq18, label %match_119, label %pattern_unmatched20

match_119:                                        ; preds = %test_117
  br label %match_merge14

pattern_unmatched20:                              ; preds = %test_117
  unreachable
}

define i32 @main() {
entry:
  %calltmp = call i32 @classify(i32 0, i32 0)
  %calltmp1 = call i32 (ptr, ...) @printf(ptr @str, i32 %calltmp)
  %calltmp2 = call i32 @classify(i32 0, i32 1)
  %calltmp3 = call i32 (ptr, ...) @printf(ptr @str.1, i32 %calltmp2)
  %calltmp4 = call i32 @classify(i32 1, i32 0)
  %calltmp5 = call i32 (ptr, ...) @printf(ptr @str.2, i32 %calltmp4)
  %calltmp6 = call i32 @classify(i32 1, i32 1)
  %calltmp7 = call i32 (ptr, ...) @printf(ptr @str.3, i32 %calltmp6)
  ret i32 0
}
